                        ...
                        <!--<h2>Properties in {{ $city }}</h2>-->
                            ...
                            @foreach ($properties as $property)
                                <!--<div class="property-card">
                                    <img src="{{ asset('storage/' . $property->image_url) }}" alt="{{ $property->name }}" width="200">
                                    <h3>{{ $property->name }}</h3>
                                ...
                                <div class="property-item rounded overflow-hidden">
                                    ...
                                    <div class="p-4 pb-0">
                                        ...
                                        <p><i class="fa fa-map-marker-alt text-primary me-2"></i>{{ $property->address_1 }}, {{ $property->city }}, {{ $property->state }}</p>
                                    </div>
                                    <div class="d-flex border-top">
                                        ...
                                        <small class="flex-fill text-center py-2"><i class="fa fa-bath text-primary me-2"></i>{{ $property->washrooms }} Bath</small>
                                    </div>
                                </div>
                            </div>
                            @endforeach
